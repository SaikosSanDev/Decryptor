...
namespace Decryptor.Forms
{
    public partial class Main : Form
    {
        ...
        {
            if(MessageBox.Show("Möchtest du wirklich alles löschen?", "Neu", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                richTextBox1.Text = "";
                richTextBox2.Text = "";
            }
        ...
        {
            string message = "Möchtest du wirklich beenden?";
            if (MessageBox.Show(message, "Beenden?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                isClosing = true;
                this.Close();
            }
        ...
        private void toolStripMenuItem2_Click(object sender, EventArgs e)
        {
            ...
            {
                Choose cho = new Choose("verschlüsselt werden.");
                cho.ShowDialog();
                if(cho.choosed > 0)
                {
                    if(cho.choosed == 1)
                    ...
                    MessageBox.Show("Verschlüsselung beendet!", "Fertig", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            else
            {
                MessageBox.Show("Der zu verschlüsselene Text darf nicht leer sein!", "Fehler", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void entschlüsslenToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Der zu entschlüsselene Text darf nicht leer sein!", "Fehler", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void textKopierenToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Text erfolgreich kopiert!", "Erfolgreich!", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void Main_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                string message = "Möchtest du wirklich beenden?";
                if(MessageBox.Show(message, "Beenden?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
                {
                    e.Cancel = true;
                }
            }
